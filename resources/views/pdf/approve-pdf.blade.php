    ...
    <table class="top_section">
        <tr>
            ...
            <td width="80%" style="text-align: center">
                ...
                <p class="website_link">Web: www.dinajpureducationboard.gov.bd, email : dinajpureducationboard@gmail.com</p>
            </td>
...
<br>
    <table>
        <tr>
            <td>
                <div><span class="subject">বিষয় : ২০২১-২০২২ শিক্ষাবর্ষে একাদশ শ্রেণিতে অধ্যয়নরত শিক্ষার্থীদের ছাড়পত্রের মাধ্যমে ভর্তির অনুমতি প্রদান প্রসঙ্গে।</span></div>
            </td>
        </tr>
    </table>

    <p class="des">
        ২০২১-২০২২ শিক্ষাবর্ষে একাদশ শ্রেণিতে অধ্যয়নরত নিম্ন বর্ণিত শিক্ষার্থীর আবেদন ও সংশ্লিষ্ট কলেজের অধ্যক্ষের সুপারিশের প্রেক্ষিতে ছাড়পত্রের মাধ্যমে ভর্তির জন্য নির্দেশক্রমে অনুমতি প্রদান করা হলো। অনুমতি পত্র ইস্যুর ১৫ (পনের) দিনের মধ্যে শিক্ষার্থীর ভর্তির কার্য সম্পাদন করতে অনুরোধ করা হলো।
    </p>
    ...
    <table class="inner_table">
        <tr>
            ...
            <td style="text-align: center"><h3 style="font-weight: 600;">নম্বর ভর্তিচ্ছু কলেজের নাম ও EIIN নম্বর</h3></td>
